package com.geekerstar.zk.demo;
...
public class ZKGetChildrenList implements Watcher {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
//		List<String> strChildList = zkServer.getZookeeper().getChildren("/geekerstar", true);
...
//		zkServer.getZookeeper().getChildren("/geekerstar", true, new ChildrenCallBack(), ctx);
		zkServer.getZookeeper().getChildren("/geekerstar", true, new Children2CallBack(), ctx);
